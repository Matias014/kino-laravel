...
<head>
    ...
    <title>Dodaj nową rezerwację produktu</title>
...
<body>
    <header>
        <h1>Dodaj nową rezerwację produktu</h1>
    </header>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-6">
                ...
                <form method="POST" action="{{ route('reservation_products.store') }}" class="needs-validation"
                    novalidate>
                    @csrf
