    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-6">
                ...
                <form method="POST" action="{{ route('films.store') }}" class="needs-validation"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <textarea id="description" name="description" class="form-control @if ($errors->first('description')) is-invalid @endif">{{ old('description') }}</textarea>
