...
<head>
    ...
    <title>Edycja Miejsca {{ $seat->id }}</title>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-6">
                ...
                <form method="POST" action="{{ route('seats.update', $seat->id) }}" class="needs-validation"
                    novalidate>
                    @csrf
                    @method('PUT')
