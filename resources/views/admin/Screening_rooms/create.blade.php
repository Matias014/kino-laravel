...
<head>
    ...
    <title>Dodaj nową salę projekcyjną</title>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-6">
                ...
                <form method="POST" action="{{ route('screening_rooms.store') }}" class="needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="number_of_rows" name="number_of_rows" type="number"
                            class="form-control @if ($errors->first('number_of_rows')) is-invalid @endif"
                            value="{{ old('number_of_rows') }}">
